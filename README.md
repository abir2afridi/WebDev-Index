# WebDev Index: Architectural Intelligence Registry 🚀

A premium, systematic categorization of core engineering assets, frameworks, and technological paradigms for modern infrastructure development.
...
- **Enhanced Sidebar**:
  - Integrated "Directory Registry" with a logical serial order (Programming Languages prioritized at #3).
  - Added `scrollbar-premium` utility for an ultra-thin, indigo-transparent scroll experience.
...
- **Architectural Directory**: Categorized engineering assets with precise technical data.
- **World of Languages**: A high-fidelity registry of global programming languages.
- **Comparison Engine**: Side-by-side analysis of technological benchmarks.
- **Strategy View (Roadmaps)**: Guided learning paths for modern system architecture.
- **Multi-language Support**: Full English and Bengali interfaces.
- **Dark/Light Modes**: Premium system-grade appearance profiles with glassmorphic accents.
...
- **Styling**: Tailwind CSS, Lucide React (Icons), Custom Design Tokens
- **Animations**: Framer Motion, DotLottie, CSS Keyframes
- **State/Caching**: React Query, Context API
